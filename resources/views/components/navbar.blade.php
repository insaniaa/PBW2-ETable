        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-3">
                <li class="nav-item me-4">
                    <a class="nav-link {{ request()->is('kelola-kelas') ? 'active-link' : '' }}" href="{{ route('kelola.kelas') }}">Kelola Kelas</a>
                </li>
                <li class="nav-item me-4">
                    <a class="nav-link {{ request()->is('kelola-jadwal') ? 'active-link' : '' }}" href="{{ route('kelola.jadwal') }}">Kelola Jadwal</a>
                </li>
                <li class="nav-item me-4">
                    <a class="nav-link {{ request()->is('kelola-matkul') ? 'active-link' : '' }}" href="{{ route('kelola.matkul') }}">Kelola Matkul</a>
                </li>
                <li class="nav-item me-4">
                    <a class="nav-link {{ request()->is('kelola-user') ? 'active-link' : '' }}" href="{{ route('kelola.user') }}">Kelola User</a>
                </li>
            </ul>
