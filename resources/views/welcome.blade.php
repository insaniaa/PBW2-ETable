...
<head>
    ...
    <style>
        ...
        .footer {
            background-color: #f8f9fa; /* Warna sama dengan navbar */
            color: #000; /* Warna teks */
            padding: 30px 50px;
            box-shadow: inset 0 6px 6px -6px rgba(0, 0, 0, 0.1); /* Shadow di atas footer */
        }
        .footer a {
            color: #000; /* Sesuaikan dengan warna teks navbar */
            text-decoration: none;
        }
        .footer a:hover {
            text-decoration: underline; /* Opsional: tambahkan hover effect */
        }
        .footer-menu {
            padding-left: 110px; /* Menggeser lebih ke kiri */
        }
        .about-text {
            text-align: justify; /* Membuat teks rata kanan-kiri */
            line-height: 1.8; /* Memberikan jarak antarbaris */
            max-width: 90%; /* Lebar teks dibuat lebih panjang (90% dari parent container) */
            margin: auto; /* Memastikan teks tetap berada di tengah */
            padding-top: 20px;
        }
        .footer-logo-text {
            padding-left: 50px; /* Geser elemen lebih ke kanan */
...
<body>
    ...
    <section id="hero" class="hero-section">
        ...
        <div class="content">
            ...
            <a href="{{ route('register') }}" class="btn btn-danger mt-3" style="width: 100px;">Mulai</a>
        </div>
    </section>

    <!-- Summary Section -->
    <section id="summary" class="summary text-center py-5">
        <h2 class="text-center mb-5">Summary</h2>
        <img src="{{ asset('images/logo.png') }}" alt="Summary Image" class="mb-3" style="width: 350px;">
        <p class="mt-4">E-Table adalah solusi manajemen jadwal yang dirancang untuk mempermudah aktivitas harian Anda.</p>
    </section>

    <!-- About Section -->
    <section id="about-us" class="about-section text-center py-5 d-flex flex-column align-items-center justify-content-center">
        <h2 class="text-center mb-5">About Us</h2>
        <img src="{{ asset('images/logo-team.png') }}" alt="Team Image" class="mb-3" style="width: 250px;">
        <div class="container">
            <p class="text-justify about-text">
                Kami adalah tim High Tech, terdiri dari tiga individu dari Program Studi D3 Rekayasa Perangkat Lunak dan Aplikasi (RPLA) kelas 4703 di Universitas Telkom. Bersama-sama, kami mengembangkan aplikasi "E-Table", yang dirancang untuk membantu pengguna mengatur waktu mereka dengan efisien. Dibuat dengan tekad untuk memberikan manfaat yang nyata, kami berkomitmen untuk terus meningkatkan aplikasi kami demi memenuhi kebutuhan pengguna dengan lebih baik. 
    ...
    <section class="meet-our-team text-center py-5">
